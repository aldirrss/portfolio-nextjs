...
const projects = [
	...
	},
	{
		...
		description:
			"Develop and create Android-based applications with Kotlin programming language and using Face Recognition.",
		stack: [{ name: "Kotlin" }, { name: "Mysql" }],
		image: "/assets/project/thumb_default.jpg",
		live: "",
	...
	},
	{
		...
		description:
			"Develop and create Android-based applications with Kotlin programming language and Midtrans Payment Method Provider.",
		stack: [{ name: "Kotlin" }, { name: "Mysql" }],
		image: "/assets/project/thumb_default.jpg",
		live: "",
		github: "https://github.com/mrAldirs/si-hijab-app.git",
	},
];
